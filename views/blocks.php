...
ts_head($net, ['title' => 'Blocks - ' . $net['label'] . ' Explorer']);
?>
...
<div class="card">
  <div class="card-b nopad table-wrap">
    <table class="blocks-tbl">
      ...
      <tbody>
      <?php foreach ($blocks as $b): $bs = ts_block_stats($net, $b['id'], (int) $b['height']); $pl = ts_block_pool($net, $b['id']); ?>
        <tr>
          ...
          <td class="amt"><?= $bs ? h(ts_coin((int) $bs['total_fee'])) : '<span class="muted">&ndash;</span>' ?></td>
      ...
      <?php endforeach; ?>
      <?php if (!$blocks): ?><tr><td colspan="8"><div class="empty"><?= ts_icon('inbox') ?><span>No blocks.</span></div></td></tr><?php endif; ?>
      </tbody>
    </table>
  </div>
</div>
